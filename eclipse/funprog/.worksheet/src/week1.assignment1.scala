...
object assignment1 {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(79); 
  ...
  */
  ...
  balance4("I told him (that it’s not (yet) done). (But he wasn’t listening)".toList);System.out.println("""res5: Boolean = """ + $show(res$5));$skip(379); 
  ...
  };System.out.println("""countChange: (money: Int, coins: List[Int])Int""");$skip(46); val res$6 = 
  
  countChange(100, List(1, 5, 10, 25, 50));System.out.println("""res6: Int = """ + $show(res$6));$skip(48); val res$7 = 
